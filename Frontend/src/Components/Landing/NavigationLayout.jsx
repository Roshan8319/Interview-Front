            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="sticky top-0 z-50 bg-white">
                        <div className='w-full flex justify-center items-center border-b-[1px] border-[#0F172A] py-2 px-4 md:px-2' >
                            <div className='w-full md:w-[90%] flex flex-col md:flex-row justify-between items-center gap-y-4 md:gap-y-0' >
                                <div className='w-full md:w-[60%] flex flex-col md:flex-row items-center gap-y-4 md:gap-y-0' >
                                    <div className='w-full md:w-[40%] flex justify-center md:justify-start' >
                                        <svg
                                            width="180"
                                            height="42"
                                            viewBox="0 0 1600 400"
                                            className="md:w-[220px] md:h-[52px]"
                                    ...
                                    <div className='w-full md:w-[60%] flex flex-wrap justify-center md:justify-start items-center gap-4 md:gap-x-12 text-black text-sm md:text-base' >
                                        <Link to='#' className='hover:text-[#E65F2B]'>Product</Link>
                                        <Link to='#' className='hover:text-[#E65F2B]'>Pricing</Link>
                                        <Link to='#' className='hover:text-[#E65F2B]'>About Us</Link>
                                    </div>
                                </div>
                                <div className='w-full md:w-[40%] flex justify-center md:justify-end items-center gap-x-4 md:gap-x-6' >
                                    <button className='text-[#E65F2B] flex font-medium whitespace-nowrap text-sm md:text-base' >
                                    ...
                                    <button className='flex justify-end' >
                                        <div 
                                            ...
                                            className='w-[100px] md:w-[116px] h-[38px] md:h-[42px] flex justify-center items-center rounded-lg border-2 border-black text-sm md:text-base'
                                        >
                                            Sign In
                                        </div>
                                    </button>
                    ...
                    <div className="bg-[#0F172A]">
                        <footer className='w-full px-4 md:w-[90%] mx-auto text-[#E2E8F0]' >
                            <div className='w-full flex flex-col md:flex-row border-b-[1px] border-[#E2E8F0] py-8 md:py-0' >
                                <div className='w-full md:w-[30%] flex flex-col gap-y-4 items-center md:items-start mt-0 md:mt-6 pb-8 md:pb-16' >
                                    {/* Logo */}
                                    ...
                                    <div className='text-[22px] md:text-[28px] font-medium text-center md:text-left' >
                                        <p>Your Engineers Build,</p>
                                        <p>We handle the interviews</p>
                                    </div>
                                </div>
                                <div className='w-full md:w-[70%] flex flex-col md:flex-row items-center md:items-start justify-center mt-6 md:mt-14 pl-0 md:pl-5 pb-8 md:pb-10 gap-8 md:gap-0' >
                                    {/* Sitemap Section */}
                                    <div className='w-full md:w-[24%] flex flex-col gap-y-3 items-center md:items-start' >
                                        <p>Sitemap</p>
                                    ...
                                    {/* Contact Section */}
                                    <div className='w-full md:w-[38%] flex flex-col gap-y-3 items-center md:items-start' >
                                        <p>Contact Us</p>
                                        <ul className='flex flex-col gap-y-3' >
                                            <li className='flex items-center gap-x-2' >
                                                <div>
                                                    <svg width="25" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clip-path="url(#clip0_368_8191)">
                                                            <path d="M12 3.9678C10.1435 3.9678 8.36301 4.70529 7.05025 6.01805C5.7375 7.3308 5 9.11128 5 10.9678C5 13.8298 6.782 16.5908 8.738 18.7298C9.73814 19.8194 10.8294 20.8217 12 21.7258C12.1747 21.5918 12.3797 21.4285 12.615 21.2358C13.5548 20.4641 14.4393 19.6273 15.262 18.7318C17.218 16.5908 19 13.8308 19 10.9678C19 9.11128 18.2625 7.3308 16.9497 6.01805C15.637 4.70529 13.8565 3.9678 12 3.9678ZM12 24.1818L11.433 23.7918L11.43 23.7898L11.424 23.7848L11.404 23.7708L11.329 23.7178L11.059 23.5208C9.69086 22.4926 8.41988 21.3411 7.262 20.0808C5.218 17.8428 3 14.6038 3 10.9668C3 8.57985 3.94821 6.29066 5.63604 4.60284C7.32387 2.91501 9.61305 1.9668 12 1.9668C14.3869 1.9668 16.6761 2.91501 18.364 4.60284C20.0518 6.29066 21 8.57985 21 10.9668C21 14.6038 18.782 17.8438 16.738 20.0788C15.5804 21.339 14.3098 22.4905 12.942 23.5188C12.8281 23.6039 12.713 23.6876 12.597 23.7698L12.576 23.7838L12.57 23.7888L12.568 23.7898L12 24.1818ZM12 8.9678C11.4696 8.9678 10.9609 9.17851 10.5858 9.55358C10.2107 9.92866 10 10.4374 10 10.9678C10 11.4982 10.2107 12.0069 10.5858 12.382C10.9609 12.7571 11.4696 12.9678 12 12.9678C12.5304 12.9678 13.0391 12.7571 13.4142 12.382C13.7893 12.0069 14 11.4982 14 10.9678C14 10.4374 13.7893 9.92866 13.4142 9.55358C13.0391 9.17851 12.5304 8.9678 12 8.9678ZM8 10.9678C8 9.90693 8.42143 8.88951 9.17157 8.13937C9.92172 7.38922 10.9391 6.9678 12 6.9678C13.0609 6.9678 14.0783 7.38922 14.8284 8.13937C15.5786 8.88951 16 9.90693 16 10.9678C16 12.0287 15.5786 13.0461 14.8284 13.7962C14.0783 14.5464 13.0609 14.9678 12 14.9678C10.9391 14.9678 9.92172 14.5464 9.17157 13.7962C8.42143 13.0461 8 12.0287 8 10.9678Z" fill="#475569" />
                                                        </g>
                                                        <defs>
                                                            <clipPath id="clip0_368_8191">
                                    ...
                                    <div className='w-full md:w-[38%] flex flex-col gap-y-3 items-center md:items-start' >
                                        ...
                                        <ul className='flex flex-col gap-y-3'>
                                            ...
                                            <li className='flex items-center gap-x-4' >
                                                <div>
                                                    <svg width="25" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M20 4.96777H4C2.89543 4.96777 2 5.8632 2 6.96777V18.9678C2 20.0723 2.89543 20.9678 4 20.9678H20C21.1046 20.9678 22 20.0723 22 18.9678V6.96777C22 5.8632 21.1046 4.96777 20 4.96777Z" stroke="#475569" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M22 7.96777L13.03 13.6678C12.7213 13.8612 12.3643 13.9638 12 13.9638C11.6357 13.9638 11.2787 13.8612 10.97 13.6678L2 7.96777" stroke="#475569" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                                <div>
                            ...
                            {/* Copyright Section */}
                            <div className='w-full flex flex-col md:flex-row justify-between items-center gap-y-4 md:gap-y-0 py-6 text-sm md:text-base' >
