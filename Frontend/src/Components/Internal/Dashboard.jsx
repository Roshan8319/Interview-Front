      ...
      <div class="flex flex-col w-1/2 p-4 h-full">
        <div className='text-black'>
          <div className='pendingTaskHeading  '>
            <h1 className='text-[16px] text-black font-bold'>
              Interviewers
              <span className='ml-2 text-black font-bold bg-[#f0ad4e] px-2 py-0.5 rounded-full text-[12px]'>38</span>
            </h1>
          </div>
          <div className='pendingTaskBox mt-4'>
            <div className="p-3 shadow-custom-color bg-gradient-to-r from-[#66B2FF] to-[#99CCFF] text-black  rounded-lg w-[90%]">
        ...
        <div className=' mt-8'>
          ...
          <div className='pendingTaskBox mt-2'>
            <div className="p-3 shadow-custom-color bg-gradient-to-r from-[#66B2FF] to-[#99CCFF] rounded-lg w-[90%]">
